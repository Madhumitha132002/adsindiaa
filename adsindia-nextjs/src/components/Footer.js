...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24">
        ...
        <path fill="#FFF" d="M15.443 19.103v-8.385h2.796l.532-3.47h-3.328V5.04c0-.95.465-1.874 1.956-1.874h1.528V.213s-1.374-.235-2.686-.235c-2.741 0-4.533 1.662-4.533 4.669v2.595H8.601v3.47h3.047v8.385h3.795z" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24">
        <defs>
          <radialGradient id="instagram-gradient" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(12 12) rotate(45) scale(16.9706)">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24">
        <path fill="#0A66C2" d="M22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0zM7.12 20.45H3.56V9h3.56v11.45zM5.34 7.43c-1.14 0-2.06-.92-2.06-2.06 0-1.14.92-2.06 2.06-2.06 1.14 0 2.06.92 2.06 2.06 0 1.14-.92 2.06-2.06 2.06zM20.45 20.45h-3.56v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.95v5.66h-3.56V9h3.42v1.56h.05c.48-.91 1.65-1.86 3.39-1.86 3.62 0 4.29 2.38 4.29 5.48v6.27z" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24">
        <path fill="#000" d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.293 19.494h2.039L6.482 3.239h-2.19l13.316 17.408z" />
      </svg>
    )
  }
];
