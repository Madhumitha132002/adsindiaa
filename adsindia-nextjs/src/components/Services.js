...
export default function Services() {
  const servicesData = [
    ...
    { title: "Voice Solutions", slug: "voice-solutions", icon: "fas fa-microphone-alt", color: "from-blue-600 to-cyan-500", image: "/images/new/Route-Mobile_Products_Voice_IVR_Banner-copy.webp", isNew: true, desc: "Professionalize your business with Multi-level IVR, Missed Call marketing, and automated voice feedback systems." },
